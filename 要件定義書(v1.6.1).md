...
Version: 1.6.1 (Docker Optimized)
...
* **Infrastructure**: Docker Compose, **Dev Containers**, Docker (Multi-stage Build), AWS (App Runner, S3), Terraform  
* **Language**: TypeScript
